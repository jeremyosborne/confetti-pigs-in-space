(function(exports) {
    ...
    */
     ...
     * @param calltype {String} The name to be associated with this type
     * of collision function, and that will affect the name of the callback. 
     * @return {Function} Constructs a function that will check two groups
     * for collisions.
     */
    var collideall = function(fn, calltype) {
        // What collision callback we'll associate with this function if
        // a collision happens.
    ...
    /**
        ...
        @param b is an array of entities that will be collided with those 
        in group a.
    */
